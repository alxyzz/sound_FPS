...
public class SpectrumAnalyzer : MonoBehaviour
{
    ...
    [HideInInspector]public float RmsValue;
    [HideInInspector] public float DbValue;
    ...
    public void SetAudio(AudioSource b)
    {
        targetAudio = b;
   ...
   public float AnalyzeSound()
    {
        targetAudio.GetOutputData(_samples, 0); // fill array with samples
        int i;
        float sum = 0;
